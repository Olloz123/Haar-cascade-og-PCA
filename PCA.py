# kode taget fra https://machinelearningmastery.com/face-recognition-using-principal-component-analysis/
# med rettelser af mig selv
...
faceimages = list(faces.values())[:32] # take last 16 images
for i in range(16):
...
query = test["grayface.pgm"].reshape(1,-1)
query_weight = eigenfaces @ (query - pca.mean_).T
euclidean_distance = np.linalg.norm(weights - query_weight, axis=0)
